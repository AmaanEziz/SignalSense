...
create procedure add_street(
	in in_streetName VARCHAR(45), in in_streetDirection VARCHAR(45), in in_beginLatitude decimal(3,0),
	in in_beginLongitude  decimal(3,0), in in_endLatitude  decimal(3,0), in in_endLongitude  decimal(3,0))
begin
...
DELIMITER $$
create procedure add_intersection(IN lat decimal(3,0), IN lon decimal(3,0))
begin
	declare uuid varchar(36);
    SET uuid = (select uuid());
